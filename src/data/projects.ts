...
export const PROJECTS: Project[] = [
	{
		proyectId: 'dentalchic',
		title: 'Dentalchic',
		coverImage: '/dentalchic-preview.webp',
		description: [
			'Diseño y de desarrollo de la web oficial de la clínica dental Dentalchic.',
			'Web limpia y moderna que muestre los servicios, equipo y contacto de la clínica. '
		],
		technologies: [
			TECHNOLOGIES.FIGMA,
			TECHNOLOGIES.NEXTJS,
